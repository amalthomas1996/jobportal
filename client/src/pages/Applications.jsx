...
const Applications = () => {
  ...
  return (
    <>
      <Navbar />
      <div className="container px-4 min-h-[75vh] 2xl:px-20 max-auto my-10">
        <h2 className="text-xl font-semibold">Your Resume</h2>
        <div className="flex gap-2 mb-6 mt-3">
          {isEdit ? (
            <>
              <label htmlFor="resumeUpload" className="flex items-center">
                <p className="bg-blue-200 text-blue-600 px-4 py-2 rounded-xl mr-2">
                  Select Resume
                </p>
                <input
                  id="resumeUpload"
              ...
              <button
                className="bg-green-200 border border-green-500 rounded-xl px-4 py-2"
